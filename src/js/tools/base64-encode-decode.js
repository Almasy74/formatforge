    ...
    root.innerHTML = `
        <div class="tool-layout">
            <div class="tool-panel tool-input-panel" style="flex: 1; display: flex; flex-direction: column;">
                ...
                <textarea id="input-data" autofocus placeholder="Paste the text or Base64 string you want to convert here..." style="flex: 1; padding: 10px; font-family: monospace; resize: none; border: 1px solid #ccc; border-radius: 4px; min-height: 300px; font-size: 15px;"></textarea>
            </div>
            ...
            <div class="tool-panel tool-output-panel" style="flex: 1; display: flex; flex-direction: column;">
                ...
                <textarea id="output-data" readonly placeholder="Result will appear here instantly..." style="flex: 1; padding: 10px; font-family: monospace; font-size: 15px; resize: none; border: 1px solid #ccc; border-radius: 4px; background: #f9f9f9; min-height: 300px; line-break: anywhere;"></textarea>
            </div>
        </div>
    `;
